...
def run(load = False, test = False, render_mode = "non"):
    env = PreyPredatorEnv(num_prey=5, num_predators=2, grid_size=30, max_steps_per_episode=100000, food_probability=1, max_food_count = 5, render_mode=render_mode, prey_split_probability=0, observation_history_length=10, food_energy_gain = 40, std_dev=5, padding = 2)
