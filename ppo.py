...
def run(load = False, test = False, render_mode = "non"):
    env = PreyPredatorEnv(num_prey=20, num_predators=4, grid_size=50, max_steps_per_episode=100000, food_probability=0.8, max_food_count = 40, render_mode=render_mode, prey_split_probability=0.04, observation_history_length=10, food_energy_gain = 40, std_dev=4, padding = 4)
