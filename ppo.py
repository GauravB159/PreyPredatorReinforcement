...
def run(load = False, test = False, render_mode = "non", config_name = None):
    ...
    print(config)
    env = PreyPredatorEnv(num_prey=15, num_predators=3, grid_size=40, food_probability=1, max_food_count = 40, render_mode=render_mode, prey_split_probability=0.02, food_energy_gain = 30, generator_params = {
        "prey": {
            "std_dev": 2, 
            "padding": 1
        },
