...
class PPO:
    def __init__(self, observation_space_dim, action_space_dim, lr=3e-4, gamma=0.99, k_epochs=4, eps_clip=0.2):
        ...
        self.policy = ActorCritic(observation_space_dim, action_space_dim).float()
        self.optimizer = optim.Adam(self.policy.parameters(), lr=lr)
        self.policy_old = ActorCritic(observation_space_dim, action_space_dim).float()
...
def main(load = False):
    ...
    max_episodes = 50000  # Adjust accordingly
