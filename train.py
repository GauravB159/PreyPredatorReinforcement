...
if __name__ == '__main__':
    env = PreyPredatorEnv(num_prey=1, num_predators=0, grid_size=50, max_steps_per_episode=100000, padding = 10, food_probability=0.05, render_mode="non", prey_split_probability=0, observation_history_length=10, food_energy_gain = 40)
